...
<li class="dropdown">
    ...
    <ul class="dropdown-menu multi-2-columns">
        <li> <a href="<?= base_url('offer'); ?>">Utwórz ogłoszenie</a></li>
                ...
                <div class="col-md-9">
                    ...
                    <div class="container">
                        <div class="row centered-form">
                            ...
                            <form action="<?= base_url('offer/add'); ?>" method="post" enctype="multipart/form-data" class="form-horizontal">
                            <input type="hidden" name="<?= csrf_token() ?>" value="<?= csrf_hash() ?>" />
                                ...
                                <fieldset>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-4">
                                            <input id="title" name="title" class="form-control input-md" type="text" value="<?= set_value('title'); ?>">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-4">
                                            <input type="text" class="form-control input-md" id="desc" name="desc" value="<?= set_value('desc'); ?>">
                                            <span class="text-danger">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-4">
                                            <input id="localization" name="localization" class="form-control input-md"
                                                type="text" value="<?= set_value('localization'); ?>">
                                            <span class="text-danger">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-4">
											...
											type="datetime-local" value="<?= set_value('enddate'); ?>">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-4">
                                            <input id="price" name="price" class="form-control input-md"
                                                type="number" value="<?= set_value('price'); ?>">
                                            <span class="text-danger">
