            ...
            <nav class="navbar container">
                ...
                <div class="navbar-collapse collapse navbar-right">
                    ...
                    <li class="active"><a href="<?= base_url('dashboard/index') ?>">Strona główna</a></li>
                        <li class="dropdown">
                            <a data-toggle="dropdown" class="dropdown-toggle" href="#">Kategorie <b
                                    class="caret"></b></a>
                            <ul class="dropdown-menu">
                                <li class="dropdown-header">Wybierz</li>
                                        ...
                                        <form action="<?= base_url('auth/save'); ?>" method="post">
                                            ...
                                            <div class="form-group">
                                                <input type="password" name="password" id="password"
                                                    class="form-control input-sm" placeholder="Password" value="<?= set_value('password'); ?>">
                                                <span class="text-danger">
                                            ...
                                            <br>
                                            <a href="<?= site_url('auth'); ?>"> Mam już konto. Zaloguj się </a>
                                        </form>
                                    </div>
                                </div>
                            </div>
