...
<?php } ?>
        ...
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="container">
                    <div class="row gx-2 " style="background-color:white">

                        <div class="col-md-6">
                              <img src="<?php echo base_url('uploads/'.$offer['file_name']); ?>" width="500" height="600"/>
                        </div>

                        <div class="col-md-6">
                        <div class="row"  style="text-align:center; height:100px">
                            <h1> <?= htmlentities($offer['title']) ?> </h1>
                    </div>
                    <div class="row" style="text-align:right; font-size:25px; margin-right:20px">  
                    <p> <?= $offer['price'] ?> ZŁ </p>  
                    <?php 

if($offer['seller_id'] == $uid || !$uid ){

} else 

{
    echo "<a href='";
    echo base_url('dashboard/transaction/'.$offer['offer_id']);
    echo "' class='button'> Kup teraz </a>";
}
...
?>
                    ...
                    <div class="row">
                    <h3> Opis </h3>   
                    <p> <?= $offer['desc'] ?> </p>  <!--  htmlentities($offer['desc'])-->
                    </div>
