        ...
        <div class="container">
            ...
            <div class="row" style="height:700px">
                ...
                <div class="container">
                    <div class="row">
                        <div class="col-lg-4 col-md-12">
                        <img src="<?php echo base_url('uploads/'.$offer['file_name']); ?>" width="100px"/>
                        </div>
                ...
                <div class="container">
                    <div class="row">
                        ...
                        <form action="<?= base_url('offer/changeStatus/'.$offer['offer_id']) ?>" method="post">
                        <button class="btn btn-secondary" type="submit">Zapłać</button>
                        </form>
